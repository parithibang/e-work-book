		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand" style="padding: 18px 36px;">
				<a href="index.html" ><img src="/static/img/logo.png" width="139" height="40" alt="eWorkBook" class="img-responsive logo" ></a>
			</div>
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="{{ urlfor "TeamController.ListTeams"}}" {{if .teamsmenu}}class="active"{{end}}><i class="lnr lnr-users"></i> <span>Teams</span></a></li>
